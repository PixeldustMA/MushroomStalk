...
export default class Page_Sandbox {
    ...
    constructor(){
        ...
        this.INSTANCE_BEETLE = new Connector_Beetle({
            ...
            BEETLE_CONFIG_LOCATION: 'DrawSandbox.js',
            BEETLE_CONFIG_SCRIPT: 'SANDBOX',
            BEETLE_CONFIG_TEXT: 'LOADING SANDBOX PAGE'
        });
        ...
        this.SECTION_Title = document.getElementById('SECTION_Sandbox-Section-Title');
