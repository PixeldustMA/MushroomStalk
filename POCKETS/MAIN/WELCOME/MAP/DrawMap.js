...
export default class DRAW_Map extends Stalk{
    ...
    async #BUTTON() {
        ...
        this.BUTTON_BACK = await new Create({
            CREATE_CONFIG_ELEMENT_TAG: 'button',
            CREATE_CONFIG_PERSONALITY_ID: 'BUTTON_Map-Back',
        }).INIT();

        this.BUTTON_CRYSTALLARIUM.innerHTML = 'CRYSTALLARIUM';
        this.BUTTON_LAVA_LAMPS.innerHTML = 'LAVA LAMPS';
        this.BUTTON_NOVA.innerHTML = 'NOVA';
        this.BUTTON_SHOPPING.innerHTML = 'MEDIA';
        this.BUTTON_BACK.innerHTML = '<<'

        this.BUTTON_TANGIBLES.innerHTML = 'TANGIBLES';
        this.BUTTON_WAR.innerHTML = 'DATABASE';
