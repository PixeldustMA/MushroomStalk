...
export default class Page_Chalkboard {
    ...
    constructor(){
        ...
        this.INSTANCE_BEETLE = new Connector_Beetle({
            ...
            BEETLE_CONFIG_LOCATION: 'DrawChalkboard.js',
            BEETLE_CONFIG_SCRIPT: 'CHALKBOARD',
            BEETLE_CONFIG_TEXT: 'LOADING CHALKBOARD PAGE'
        });
        ...
        this.SECTION_Title = document.getElementById('SECTION_Chalkboard-Section-Title');
    ...
    async DRAW_PAGE() {
        ...
        this.INSTANCE_BEETLE.DAISY_TEXT = 'DRAWING CHALKBOARD PAGE';
    ...
    /**
     * ## INITIALISE THE CHALKBOARD PAGE
     * 
     * -------------------
     * 
     * #### === ASYNC FUNCTION ==
    ...
    async INITIALISE() {
        ...
        this.INSTANCE_BEETLE.DAISY_TEXT = 'INITIALISING CHALKBOARD PAGE';
    ...
    async TEXT () {
        this.HEADER_PAGE = await new Create({
            ...
            CREATE_CONFIG_PERSONALITY_ID: 'HEADER_Chalkboard-Title-Present',
        }).INIT();
    };
};

const Page = new Page_Chalkboard();
