...
export default class Page_Observatory {
    ...
    constructor(){
        ...
        this.INSTANCE_BEETLE = new Connector_Beetle({
            ...
            BEETLE_CONFIG_LOCATION: 'DrawObservatory.js',
            BEETLE_CONFIG_SCRIPT: 'OBSERVATORY',
            BEETLE_CONFIG_TEXT: 'LOADING OBSERVATORY PAGE'
        });
        ...
        this.SECTION_Title = document.getElementById('SECTION_Observatory-Section-Title');
    ...
    async DRAW_PAGE() {
        ...
        this.INSTANCE_BEETLE.DAISY_TEXT = 'DRAWING OBSERVATORY PAGE';
    ...
    /**
     * ## INITIALISE THE OBSERVATORY PAGE
     * 
     * -------------------
     * 
     * #### === ASYNC FUNCTION ==
    ...
    async INITIALISE() {
        ...
        this.INSTANCE_BEETLE.DAISY_TEXT = 'INITIALISING OBSERVATORY PAGE';
    ...
    async TEXT () {
        this.HEADER_PAGE = await new Create({
            ...
            CREATE_CONFIG_PERSONALITY_ID: 'HEADER_Observatory-Title-Present',
        }).INIT();
    };
};

const Page = new Page_Observatory();
