...
export default class Page_Library {
    ...
    constructor(){
        ...
        this.INSTANCE_BEETLE = new Connector_Beetle({
            ...
            BEETLE_CONFIG_LOCATION: 'DrawLibrary.js',
            BEETLE_CONFIG_SCRIPT: 'LIBRARY',
            BEETLE_CONFIG_TEXT: 'LOADING LIBRARY PAGE'
        });
        ...
        this.SECTION_Title = document.getElementById('SECTION_Library-Section-Title');
    ...
    async DRAW_PAGE() {
        ...
        this.INSTANCE_BEETLE.DAISY_TEXT = 'DRAWING LIBRARY PAGE';
    ...
    async INITIALISE() {
        ...
        this.INSTANCE_BEETLE.DAISY_TEXT = 'INITIALISING LIBRARY PAGE';
    ...
    async TEXT () {
        this.HEADER_PAGE = await new Create({
            ...
            CREATE_CONFIG_PERSONALITY_ID: 'HEADER_Library-Title-Present',
        }).INIT();
    };
};

const Page = new Page_Library();
