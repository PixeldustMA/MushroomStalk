...
export default class Page_Office {
    ...
    constructor(){
        ...
        this.INSTANCE_BEETLE = new Connector_Beetle({
            ...
            BEETLE_CONFIG_LOCATION: 'DrawOffice.js',
            BEETLE_CONFIG_SCRIPT: 'OFFICE',
            BEETLE_CONFIG_TEXT: 'LOADING OFFICE PAGE'
        });
        ...
        this.SECTION_Title = document.getElementById('SECTION_Office-Section-Title');
    ...
    async DRAW_PAGE() {
        ...
        this.INSTANCE_BEETLE.DAISY_TEXT = 'DRAWING OFFICE PAGE';
    ...
    async INITIALISE() {
        ...
        this.INSTANCE_BEETLE.DAISY_TEXT = 'INITIALISING OFFICE PAGE';
    ...
    async TEXT () {
        this.HEADER_PAGE = await new Create({
            ...
            CREATE_CONFIG_PERSONALITY_ID: 'HEADER_Office-Title-Present',
        }).INIT();
    };
};

const Page = new Page_Office();
