...
export default class Page_Kitchen {
    ...
    constructor(){
        ...
        this.INSTANCE_BEETLE = new Connector_Beetle({
            ...
            BEETLE_CONFIG_LOCATION: 'DrawKitchen.js',
            BEETLE_CONFIG_SCRIPT: 'KITCHEN',
            BEETLE_CONFIG_TEXT: 'LOADING KITCHEN PAGE'
        });
        ...
        this.SECTION_Title = document.getElementById('SECTION_Kitchen-Section-Title');
    ...
    async DRAW_PAGE() {
        ...
        this.INSTANCE_BEETLE.DAISY_TEXT = 'DRAWING KITCHEN PAGE';
    ...
    async INITIALISE() {
        ...
        this.INSTANCE_BEETLE.DAISY_TEXT = 'INITIALISING KITCHEN PAGE';
    ...
    async TEXT () {
        this.HEADER_PAGE = await new Create({
            ...
            CREATE_CONFIG_PERSONALITY_ID: 'HEADER_Kitchen-Title-Present',
        }).INIT();
    };
};

const Page = new Page_Kitchen();
