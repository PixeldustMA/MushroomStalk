...
export default class Draw_Menu_Director extends Stalk {
    ...
    async #HEADERS(){
        ...
        this.HEADER_PAGE.innerHTML = 'DIRECTORS';
...
const PAGE_Menu_Books = new Draw_Menu_Director();
