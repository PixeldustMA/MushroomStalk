...
export default class Draw_Menu_Artist extends Stalk {
    ...
    async #HEADERS(){
        ...
        this.HEADER_PAGE.innerHTML = 'ARTISTS';
...
const PAGE_Menu_Books = new Draw_Menu_Artist();
