...
export default class Draw_Menu_Style extends Stalk {
    ...
    async #HEADERS(){
        ...
        this.HEADER_PAGE.innerHTML = 'STYLES';
...
const PAGE_Menu_Style = new Draw_Menu_Style();
await PAGE_Menu_Style.INITIALISE();
PAGE_Menu_Style.DRAW();