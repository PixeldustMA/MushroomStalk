...
export default class EL_INPUT_Description {
    ...
    async #LABELS() {
        ...
        this.LABEL_DESCRIPTION_CODE.innerHTML = 'Input new element description code';
        this.LABEL_DESCRIPTION_TEXT.innerHTML = 'Input new element description';
    };
    async #INSTRUCTIONS() {
