...
class Panel_Geological {
    ...
    PANEL_INPUT_LOCATION(){
        ...
        buttonSubmit.addEventListener('click', (SUBMIT_EVENT) => {
            ...
            const geologicalPlanetNameSelect = this.planetPanel.planetBox
            const geologicalPlanetName = geologicalPlanetNameSelect.options[geologicalPlanetNameSelect.selectedIndex].text;
            this.instanceGeological.GENERATE_GEOLOGICAL_LOCATION(geologicalName, geologicalType, geologicalElement, geologicalColour, geologicalDescription, geologicalPlanetName)
    ...
    async INITIALISE(){
        ...
        this.planet =  await this.planetPanel.CHOOSE_PLANET();
        this.locationTypes = Object.keys(await this.instanceGeological.READ_GEOLOGIAL_TYPES());
        this.locationElements = Object.keys(await this.instanceElements.instanceElements.READ_ELEMENTS_ALL());
        this.locationColours = Object.keys(await this.instanceColours.instanceColours.READ_COLOURS_ALL());
    };
};

export {Panel_Geological}