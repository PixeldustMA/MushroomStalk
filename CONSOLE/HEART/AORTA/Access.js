...
contextBridge.exposeInMainWorld(
	...
	'ipcRender', {
        ...
        ACCESS_WINDOW_New: (PATH_Page) => ipcRenderer.invoke('handler_newwindow', PATH_Page),
        ACCESS_STALK_Save: (PATH_File, DATA_Details) => ipcRenderer.invoke('handler_saveNote', PATH_File, DATA_Details),
        ACCESS_STALK_Markdown: (PATH_File, DATA_Details) => ipcRenderer.invoke('handler_saveMarkdown', PATH_File, DATA_Details),
        ...
        ACCESS_PATH_Retrieve: (PATH_Tag, PATH_Username) => ipcRenderer.invoke('handler_getPath', PATH_Tag, PATH_Username),
        ACCESS_PATH_Status: (PATH_File) => ipcRenderer.invoke('handler_readStatus', PATH_File),
        ACCESS_PATH_Pockets: (PATH_Pocket) => ipcRenderer.invoke('handler_pathPocket', PATH_Pocket),
